    ...
    <xsl:template match="act:Contractor">
        ...
        <table class="tbl_section_content">
            <tbody>
                ...
                <tr>
                    <td width="50%">
                        <xsl:text>Наименование саморегулируемой организации в сфере кадастровых отношений, если кадастровый инженер является членом такой организации </xsl:text>
                    </td>
                    <td width="50%">
                        <input class="pole" type="text"/>
                    </td>
                ...
                <tr>
                    <td width="50%">
                        <xsl:text>Сокращенное наименование юридического лица, если кадастровый инженер является работником юридического лица, адрес местонахождения юридического лица </xsl:text>
                    </td>
                    <td width="50%">
                        <ins>
                            <xsl:value-of
                ...
                <tr>
                    <td width="50%">
                        <xsl:text>№ и дата заключения договора на выполнение кадастровых работ </xsl:text>
                    </td>
                    <td width="50%">
                        <input class="pole" type="text"/>
                    </td>
